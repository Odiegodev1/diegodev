...
export function Cadrmyskill(){
    const FrontEnd: FrontEndProps[] = [
         {
      label: "React",
      svg: (
        <svg width="48" height="48" viewBox="0 0 24 24" className="text-cyan-400" fill="none" stroke="currentColor" strokeWidth="2">
...
<path fill="#4db6ac" d="M44.284,36.035L27.687,1.429c-0.855-1.783-3.337-1.93-4.397-0.26L4.886,30.177	c-0.397,0.625-0.385,1.426,0.029,2.04l9.271,13.738c0.575,0.852,1.634,1.237,2.623,0.953l25.942-7.458	C44.208,39.031,44.939,37.402,44.284,36.035z M40.618,37.279L18.8,43.388c-0.505,0.142-0.98-0.305-0.87-0.818l7.735-36.097	c0.139-0.65,1.023-0.755,1.311-0.157l14.265,29.621C41.489,36.481,41.194,37.118,40.618,37.279z"></path>
    ...
    >
     ...
     const Renderdb =  Bdanco.map((item) => {
       return(
           <Card
      key={item.label}
      className="
 ...
 const Backrender =  BackEnd.map((item) => {
       return(
           <Card
      key={item.label}
      className="
  ...
  const render =  FrontEnd.map((item) => {
       return(
           <Card
      key={item.label}
      className="
    ...
    return(
        <div className="grid md:grid-cols-2 p-4 w-full gap-10 mb-50">
            <MagicCard className="border-2  rounded-md p-2 py-5  ">
                 <CardHeader className="cursor-none">
                      <CardTitle className="text-xl font-semibold">Front End</CardTitle>                    
                 </CardHeader>
                <CardContent className="cursor-none">
                    <div className="w-full mt-4 md:gap-6 gap-2 grid md:grid-cols-4 grid-cols-3">
                     {render}
            ...
            <MagicCard className="border-2 rounded-md p-2 py-5  ">
                 <CardHeader className="cursor-none">
                      <CardTitle className="text-xl font-semibold">Back End</CardTitle>                    
                 </CardHeader>
                <CardContent className="cursor-none">
                    <div className="w-full mt-4 md:gap-6 gap-2 grid md:grid-cols-4 grid-cols-3">
                     {Backrender}
                        ...
                        <MagicCard className="border-2 rounded-md p-2 py-5  ">
                 <CardHeader className="cursor-none">
                      <CardTitle className="text-xl font-semibold">Banco de dados</CardTitle>                    
                 </CardHeader>
                <CardContent className="cursor-none">
                    <div className="w-full mt-4 md:gap-6 gap-2 grid md:grid-cols-4 grid-cols-3">
                     {Renderdb}
                                  ...
                                  <MagicCard className="border-2 cursor-none rounded-md p-2 py-5  ">
                 <CardHeader className="cursor-none">
                      <CardTitle className="text-xl font-semibold">Ferramentas</CardTitle>                    
                 </CardHeader>
                <CardContent className="cursor-none">
                    <div className="w-full mt-4 md:gap-6 gap-2 grid md:grid-cols-4 grid-cols-3">
                     {rendefront}
